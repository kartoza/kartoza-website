...
client: ''
date: '2022-08-02'
description: Ogun State in Nigeria started implementation in 2012 of their first digital
  Spatial Data Infrastructure (SDI). At its core are new Land Information and Land
  Administration Systems, of which Kartoza wa
erpnext_id: 749e98afca
erpnext_modified: '2026-02-25 08:53:12.877298'
github: https://github.com/kartoza/parcel_plugin
...
- QGIS
- Python
thumbnail: https://erp.kartoza.com/files/ogungis2.png
...
Ogun State in Nigeria started implementation in 2012 of their first digital Spatial Data Infrastructure (SDI). At its core are new Land Information and Land Administration Systems, of which Kartoza was the core developer. Data are housed in PostGIS and published using Geoserver and PHP in a custom implementation of the 1map platform (<http://1map.co.za>).

The core requirements were to:

• Provide infrastructure, tools and training to digitise all the historical paper cadastral records of Ogun State
