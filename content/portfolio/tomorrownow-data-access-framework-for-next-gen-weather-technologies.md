...
- Project
technologies: []
thumbnail: https://erp.kartoza.com/files/map_1.png
title: TomorrowNow Data Access Framework for Next-Gen Weather Technologies
---
...
>}}
An OSIRIS Data Service with a series of restful Application Programming Interfaces (API), geospatial-enabled image services, and Open-source Project for a Network Data Access Protocol (OPeNDAP) services. These three different service offerings to support data discovery, access, and distribution to the user base as Analysis Ready Data (ARD) and as direct application inputs to decision-to-support tools.
{{< /block >}}
...
Key aspects of the included:
  ...
  2. Using STAC, OGC API - Records, custom APIs, Intake, and the AWS open data registry for metadata and search.
