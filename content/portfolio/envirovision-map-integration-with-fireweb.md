...
The interactions include:
  ...
  1. **Center On** : Centring the map on the user's location (or custom location override) or defined regions of interest.
  ...
  4. **Cameras:** Displaying a list of cameras from a database, centring the map on a selected camera, and providing access to camera images and information.
  5. **Weather Stations:** Displaying a list of weather stations from a database, centring the map on a selected station, and providing weather details.
  ...
  10. Auto plot by favourite group - Selecting all cameras within a favourite group and displaying a visible polygon. Users should be able to save, edit, and delete the region of interest from the auto-plot.
