...
When there is a change in the Docker code in the [GitHub repositories listed on Docker Hub](<https://hub.docker.com/search?q=kartoza>), Docker Hub picks them up and updates the images.
