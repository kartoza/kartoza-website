...
- Mobile GIS apps (iOS, Android, cross-platform)
- QGIS plugins and extensions
- PostGIS database applications
- Spatial data pipelines and ETL
...
- **Frontend**: React, Vue.js, OpenLayers, Leaflet, MapLibre
