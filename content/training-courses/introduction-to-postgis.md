...
<div class="material-card material-card-with-icon">
    <span class="material-icon" aria-hidden="true">
        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg></svg></span>
...
<div class="course-modules">
  ...
  <details class="course-module">
    <summary><span class="course-module-number">1</span><strong>Introduction to PostgreSQL &amp; PostGIS</strong><span class="course-module-time">Day 1 · Morning</span></summary>
    <p>Understand the geospatial RDBMS architecture and how PostGIS extends PostgreSQL for geographic data. You'll explore the PostGIS geometry types, spatial reference systems, and the key functions that make spatial SQL possible. By the end of this module you'll know why a spatial database outperforms shapefile workflows for real-world data management.</p>
  </details>
  <details class="course-module">
    <summary><span class="course-module-number">2</span><strong>SQL Fundamentals for Spatial Data</strong><span class="course-module-time">Day 1 · Afternoon</span></summary>
    <p>Build confidence writing SQL from scratch — tables, fields, primary and foreign keys, and full CRUD operations (CREATE, READ, UPDATE, DELETE). No prior database experience required. You'll write your first spatial queries and learn the conventions that make SQL readable and maintainable in a team environment.</p>
  </details>
  <details class="course-module">
    <summary><span class="course-module-number">3</span><strong>Spatial Queries &amp; PostGIS Functions</strong><span class="course-module-time">Day 2 · Morning</span></summary>
    <p>Insert and manipulate geometries, run spatial queries, and apply PostGIS functions and operators. You'll work with ST_Intersects, ST_Buffer, ST_Distance, ST_Area, coordinate transformations, and spatial joins. By the end of this module you'll be comfortable answering real-world "where" questions using SQL against a live spatial database.</p>
  </details>
  <details class="course-module">
    <summary><span class="course-module-number">4</span><strong>QGIS Integration &amp; Enterprise Workflows</strong><span class="course-module-time">Day 2 · Afternoon</span></summary>
    <p>Connect your PostGIS database to QGIS using DB Manager. Import and export spatial data, visualise query results on a map, and explore how PostGIS fits into a FOSS enterprise GIS stack alongside GeoServer and GeoNode. The session closes with a bring-your-own-data exercise where you apply the day's skills to a real dataset of your choice.</p>
  </details>
</div>
...
<div class="materials-grid">
  ...
  <p class="material-item">
    ...
    <span>PostGIS reference guide & workbook</span></p>
</div>
  ...
  <div class="material-card">
    ...
    <span>SQL cheat sheets & query templates</span>
  </div>
  ...
  <svg class="material-card-icon" width="16" height="16" fill="none"
    ...
    <span>All-inclusive: VAT, software & materials (instructor-led)</span>
  </div>
</div>
...
<section class="course-testimonials" aria-label="Course testimonials">
  <div class="course-testimonials-viewport">
    <div class="course-testimonials-track">
      <article class="course-testimonial-card"><div class="course-testimonial-author"><span class="course-testimonial-avatar">LS</span><span><strong>L. Strijdom</strong><span class="course-testimonial-rating">★★★★★</span></span></div><blockquote>The course is a perfect quick start guide to PostGIS and pgAdmin. The content was thorough, with comprehensive information on the slides as well as the provided documents. The steps in the exercises are easy to follow and I really appreciated that the complete version was also provided for reference. The presenter is knowledgeable and moves through the content with efficiency, but takes enough time to answer questions and make sure everyone is keeping up. The supplemental resources are also appreciated and useful for further self study.</blockquote></article>
