...
date: '2014-12-27'
description: 'In this article I will detail how to set up a simple orchestrated system
  of docker containers using: PostGIS GeoServer </'
erpnext_id: /blog/docker/orchestrating-geoserver-with-docker-and-fig
erpnext_modified: '2014-12-27'
reviewedBy: Automated Check
reviewedDate: '2026-04-13'
tags:
- Docker
thumbnail: /img/blog/erpnext/fDL6CrX.png
...
The '-d' flag puts the services into the background. You can check out this repo: [https://github.com/timlinux/geoserver-deploy](<https://github.com/timlinux/geoserver-deploy%C2%A0>) if you want to get the project used in this article. See the fig documentation for other things you can do once your service is running - fig basically lets you manage the suite of services as a single unit, bringing them up or down with a single command.
