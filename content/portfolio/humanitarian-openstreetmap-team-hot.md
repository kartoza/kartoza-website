...
client: ''
date: '2025-01-17'
description: Kartoza collaborated with the Humanitarian OpenStreetMap Team to strengthen
  open-source geospatial platforms and standards for humanitarian use. The work included
  designing the next generation of Open
erpnext_id: 9g0s7v4apc
erpnext_modified: '2026-06-04 14:38:34.905862'
github: ''
...
- GeoServer
- GeoNode
thumbnail: https://erp.kartoza.com/files/HOT.png
...
>}}
Kartoza collaborated with the Humanitarian OpenStreetMap Team to strengthen open-source geospatial platforms and standards for humanitarian use. The work included designing the next generation of OpenAerialMap and supporting the standardisation of healthcare facility data within the OpenStreetMap ecosystem.
{{< /block >}}
