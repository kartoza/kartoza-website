...
client: World Bank
date: '2025-01-20'
description: Kartoza was contracted by the World Bank to further develop the Gender
  Enabling Environments  Spatial Tool (GEEST) which leverages geospatial data to identify
  and address barriers to employment. By re
erpnext_id: p7vn3v528j
erpnext_modified: '2026-02-20 10:54:21.645428'
github: https://github.com/kartoza/GEEST2
...
- Python
- Qt
thumbnail: https://erp.kartoza.com/files/GLvgrGs.png
title: Gender Enabling Environments Spatial Tool (GEEST) Plugin
---
...
>}}
Kartoza was contracted by the World Bank to further develop the Gender Enabling Environments  Spatial Tool (GEEST) which leverages geospatial data to identify and address barriers to employment. By refining spatial insights, GEEST empowers decision-makers to create more inclusive, opportunity-rich environments for women in the energy sector.
{{< /block >}}
...
[Project Repository](<https://github.com/worldbank/GEEST/>)
...
![](https://kartoza.com/files/GLvgrGs.png)
 ...
 _GEEST Accessibility Score, as seen in the GEEST plugin for St Lucia_
